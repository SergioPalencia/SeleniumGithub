...
public class AbstractSearchEngine {
    ...
    protected int totalBusquedas = 0;
    ...
    // Optimizado mediante al adelantar en la cola los movimientos que acercan al extremo derecho inferior
    protected Dimension [] getPossibleMovesOptimizado(Dimension loc) {
        Dimension tempMoves [] = new Dimension[4];
        tempMoves[0] = tempMoves[1] = tempMoves[2] = tempMoves[3] = null;
        int x = loc.width;
        int y = loc.height;
